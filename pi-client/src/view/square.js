...
import { makeEventEmitter, makeDeltaQueryF, fixDataTypes, vlApiToSpec, makeVLRenderer } from "./util.js"
...
export function Square() {
  ...
  */
  square.create = ( (spec, domEl, wf) => {
    ...
    view.source_iact = [];
    view.mark = vl.markSquare({filled: false, tooltip: { content: "data" }}).data([]);
